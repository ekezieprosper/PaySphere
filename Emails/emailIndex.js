...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>This is your wallet ID: <b style="font-size: 16px; letter-spacing: 2px; color: #333;">${walletID}</b> is your unique ID for account access, and will also be required for both login and transactions. Click the button below to get started.</p>
        </div>
